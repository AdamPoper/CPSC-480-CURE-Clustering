...
# the x value is age, the y value is income, 
# gender will be either 1 for male and 0 for female
class Vertex:
    def __init__(self, _x=0, _y=0, gender=-1):
        ...
        self.gender = gender
    def __repr__(self):
        return f"(Age: {self.x}, Income: {self.y}, Gender: {self.gender})"
...
class Cluster:
    ...
    def calc_representative_points(self):
        ...
        best_scat0 = Vertex(rep0.x, rep0.y, -1)   
        ...
        best_scat1 = Vertex(rep1.x, rep1.y, -1)
